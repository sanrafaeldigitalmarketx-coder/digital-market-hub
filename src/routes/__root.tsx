...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Plataforma privada de comercio digital. Descubre emprendedores, negocios y empresas con catálogos, productos y planes adaptados a tu nivel." },
      { name: "author", content: "Jovany Gonzalez" },
      { property: "og:title", content: "SanRafael DigitalMarket" },
      { property: "og:description", content: "Plataforma privada de comercio digital. Descubre emprendedores, negocios y empresas con catálogos, productos y planes adaptados a tu nivel." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "SanRafael DigitalMarket" },
      { name: "twitter:description", content: "Plataforma privada de comercio digital. Descubre emprendedores, negocios y empresas con catálogos, productos y planes adaptados a tu nivel." },
